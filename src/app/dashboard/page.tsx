          ...
          <>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              ...
              <div className="flex space-x-4">
                ...
                <button 
                  onClick={() => setActiveSection('performance')}
                  className="bg-green-100 text-green-700 px-6 py-3 rounded-lg font-medium hover:bg-green-200 transition-colors"
                >
                  📊 View Performance
                </button>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="border-2 border-dashed border-gray-200 p-6 rounded-lg text-center">
                  ...
                  <p className="text-gray-600">Register for competitions and track your performance against other athletes.</p>
                </div>
              </div>
            </div>
          </>
