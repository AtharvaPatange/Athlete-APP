...
export default function InjuryReportForm({ onSubmitSuccess, onCancel, initialData }: InjuryReportFormProps) {
  ...
  const renderStep5 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Treatment & Recovery Plan</h2>
        <p className="text-gray-600">Add treatment details and activity restrictions</p>
      </div>
